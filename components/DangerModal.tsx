    ...
    >
      <View className="flex-1 justify-end items-center">
        <View
          ...
          className="mx-3 mb-4 px-6 py-6 items-center gap-2 bg-white shadow-lg elevation-sm-lg shadow-slate-200 rounded-lg"
        >
          <Text className="font-bold text-slate-800">{title}</Text>
          <Text className="text-slate-800">{prompt}</Text>
